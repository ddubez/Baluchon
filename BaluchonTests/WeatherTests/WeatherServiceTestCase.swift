...
class WeatherServiceTestCase: XCTestCase {
    ...
    func testGetWeatherShouldPostFailedCallbackIfError() {
        ...
        weatherService.getWeather(firstCityId: "5128581", secondCityId: "3031582") { (success, weatherDataList, error) in
    ...
    func testGetWeatherServiceShouldPostSuccessCallback() {
        ...
        WeatherService.shared.getWeather(firstCityId: "5128581", secondCityId: "3031582") { (success, weatherDataList, error) in
