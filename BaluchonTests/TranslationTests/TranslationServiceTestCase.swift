...
class TranslationServiceTestCase: XCTestCase {
    ...
    func testGetTranslationShouldPostFailedCallbackIfError() {
        ...
        translationService.getTranslation(textToTranslate: "Bonjour", source: "fr", target: "en") { (success, translation, error) in
            // Then
    ...
    func testGetTranslationServiceShouldPostSuccessCallback() {
        ...
        // When
        let expectation = XCTestExpectation(description: "Wait for queue change.")
        TranslationService.shared.getTranslation(textToTranslate: "Bonjour", source: "fr", target: "en") { (success, translation, error) in
            // Then
            XCTAssertTrue(success)
            XCTAssertEqual(error, "")
